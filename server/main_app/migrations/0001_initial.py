    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_in_map', models.CharField(max_length=20)),
                ('type', models.CharField(max_length=50)),
                ('address_region', models.CharField(max_length=30)),
                ('address_district', models.CharField(max_length=30)),
                ('address_village_council', models.CharField(blank=True, max_length=30)),
                ...
                ('place_plate', models.CharField(max_length=100)),
                ('distance_front', models.CharField(max_length=4)),
                ('distance_left', models.CharField(max_length=4)),
                ('distance_right', models.CharField(max_length=4)),
                ('description', models.CharField(max_length=355)),
                ('note', models.CharField(max_length=355)),
                ('date_last_check', models.DateTimeField()),
